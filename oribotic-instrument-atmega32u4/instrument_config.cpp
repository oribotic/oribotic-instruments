...
uint8_t intervaldelay = INTERVALDELAY;
    ...
    // LINEAR BEND TABLE
        ...
        struct orikey orikeys[PANELCOUNT] = {
            // row 1
            {.pin = 2, .panel = 0, .note = 2, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  0
            {.pin = 3, .panel = 0, .note = 3, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  1
            {.pin = 0, .panel = 0, .note = 8, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  6
            {.pin = 1, .panel = 0, .note = 9, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  7
            {.pin = 5, .panel = 0, .note = 4, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  2
            {.pin = 4, .panel = 0, .note = 5, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  3
            {.pin = 7, .panel = 0, .note = 7, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  5
            {.pin = 6, .panel = 0, .note = 6, .hard = 1024, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  4
        };
        #endif
    ...
    struct orikey orikeys[PANELCOUNT] = {
        // row 1
        {.pin = 5, .panel = 0, .note = 4, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  2
        {.pin = 4, .panel = 0, .note = 5, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  3
         //
        {.pin = 0, .panel = 0, .note = 8, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  6
        {.pin = 1, .panel = 0, .note = 9, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  7
        //
        {.pin = 7, .panel = 0, .note = 7, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  5
        {.pin = 6, .panel = 0, .note = 6, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  4
        //
        {.pin = 2, .panel = 0, .note = 2, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  0
        {.pin = 3, .panel = 0, .note = 3, .hard = 70, .soft = 0, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  1
    };  
        ...
        // VERSION 2
        // {.pin = 5, .panel = 0, .note = 2, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  0
        // {.pin = 4, .panel = 0, .note = 3, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  1
        // {.pin = 0, .panel = 0, .note = 8, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  6
        // {.pin = 1, .panel = 0, .note = 9, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  7
        // {.pin = 7, .panel = 0, .note = 4, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  2
        // {.pin = 6, .panel = 0, .note = 5, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  3
        // {.pin = 3, .panel = 0, .note = 7, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  5
        // {.pin = 2, .panel = 0, .note = 6, .hard = 70, .bendLO = 100, .bendHI = 1023, .state = 0, .last = 0},  //  4
